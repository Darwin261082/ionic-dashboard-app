...
var Range = class {
  ...
  render() {
    ...
    }, part: "label" }, label !== void 0 ? h("div", { class: "label-text" }, label) : h("slot", { name: "label" })), h("div", { key: "3c275d822b29a8008e044722e8b6bdabd3ecfad7", class: "native-wrapper" }, h("slot", { key: "03c849d0aa708914984ad57ca292bc5fc66ecad5", name: "start" }), this.renderRangeSlider(), h("slot", { key: "10ca7b8152cac00b45d8fa98ad91410f59fd176a", name: "end" }))));
  }
  get el() {
...
@ionic/core/dist/esm/ion-range.entry.js:
   ...
   *)
*/
//# sourceMappingURL=ion-range.entry-DPGJL5SF.js.map
